      ...
      <div className={styles.content}>
        ...
        {editingUser && (
          <form className={styles.editForm} onSubmit={handleUpdate}>
            ...
            <label>
              Phone Number:
              <input type="text" name="phonenumber" value={editFormData.phonenumber} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Email:
              <input type="email" name="email" value={editFormData.email} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Password:
              <input type="text" name="password" value={editFormData.password} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Name:
              <input type="text" name="name" value={editFormData.additionalInfo.name} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Lastname:
              <input type="text" name="lastname" value={editFormData.additionalInfo.lastname} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Birthday:
              <input type="date" name="birthday" value={editFormData.additionalInfo.birthday} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Birthplace:
              <input type="text" name="birthplace" value={editFormData.additionalInfo.birthplace} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Gender:
              <input type="text" name="gender" value={editFormData.additionalInfo.gender} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              PersonalNr:
              <input type="text" name="personalNr" value={editFormData.additionalInfo.personalNr} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Balance:
              <input type="number" name="balance" value={editFormData.additionalInfo.balance} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              BalanceCoins:
              <input type="number" name="balanceCoins" value={editFormData.additionalInfo.balanceCoins} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Min:
              <input type="number" name="min" value={editFormData.additionalInfo.min} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              SMS:
              <input type="number" name="sms" value={editFormData.additionalInfo.sms} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
            <label>
              Internet:
              <input type="number" name="internet" value={editFormData.additionalInfo.internet} onChange={(e) => handleChange(e, setEditFormData)} required />
            </label>
